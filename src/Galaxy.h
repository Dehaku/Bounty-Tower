    ...
    { // TODO: Replace this with a Class containing Critter types and amounts, Probably inventories as well, Or start up premade critters.
        if (Type == "Test")
        {
            ...
            if (true == true)
            {
                ...
                {
                    std::cout
                        << "Problem during initalization of NPC Spawns. \n";
                }
                if (Debug)
                {
                    std::cout << "PostInt\n";
            ...
            if (true == true)
            {
                ...
                try
                {
                         ...
                         count++)
                    {
                        ...
                        npcmanager.AddedCritters.push_back(
                            Squady.Squad.at(count));
                    }
        ...
        { // Running through factions, Probably needs it's own function.
                        ...
                        { // Declare War.
                            ...
                            for (size_t z = 0; z != UniFact.size(); z++)
                            {
                                if (UniFact[z].Name == Tenant)
                                {
                                    ...
                                    TenantTech +=
                                        UniFact[z].TechWeaponryExplosive;
                                    ...
                                    InvaderTech +=
                                        UniFact[i].TechWeaponryEnergy;
                                    InvaderTech +=
                                        UniFact[i].TechWeaponryExplosive;
                                    ...
                                    float TenantPower =
                                        TenantTechnique *
                                        (PercentIs(UniFact[z].Members, 60) *
                                         0.01);
                                    float InvaderPower =
                                        InvaderTechnique *
                                        (PercentIs(UniFact[i].Members, 60) *
                                         0.01);
            ...
            { // Spawning and assigning factions their starting territory.
                ...
                if (WorldMap[x][y].Owner == "")
                {
                    ...
                    std::cout << UniFact[i].Name << " has claimed " << x << "/"
                              << y << std::endl;
                }
            }
